            ...
            <div className="flex gap-2">
				<div className="w-72">
					<div className="relative rounded-md shadow-sm">
						<input type="text" className="block w-full pl-3 pr-32 sm:text-sm rounded-md focus:ring-indigo-500 focus:border-indigo-500 border-gray-300" placeholder="superdoména" onChange={e => setdomainName(e.target.value)}/>
						<div className="absolute inset-y-0 right-0 flex items-center">
							<label htmlFor="currency" className="sr-only">TLD</label>
							<input id="tld-choice" name="tld-choice" list="tlds" placeholder=".cz" className="w-32 h-full py-0 pl-2 pr-1 sm:text-sm rounded-md focus:ring-indigo-500 focus:border-indigo-500 border-transparent bg-transparent text-gray-500" onChange={e => setselectedTLD(e.target.value)}/>
							<datalist id="tlds">
